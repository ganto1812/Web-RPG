...
<header>
    ...
    <div class="navbar fixed-top navbar-expand-lg navbar-dark" id="navbar">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item"><a class="nav-link" href="Account/index.html">Account</a></li>
            <li class="nav-item"><a class="nav-link" href="Settings/index.html">Settings</a></li>
            <li class="nav-item"><a class="nav-link" href="About/index.html">About</a></li>
            <li class="nav-item"><a class="nav-link" href="Help/index.html">Help</a></li>
        </ul>
        ...
        <div class="logInWindow">
            <form class="form" action="includes/login.php" method="POST">
                <div class="imgcontainer">
                    <img src="pics/hero.svg" alt="image" class="loginIcon">
                </div>
